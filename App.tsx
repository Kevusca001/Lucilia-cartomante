...
const SITE_DATA = {
  ...
  catalog: [
    ...
    { id: 'cigano-5', category: DeckCategory.CIGANO, title: 'Caminho Afetivo', description: 'O que Ele(a) sente? + Como agir? (15 min)', price: 'R$ 50', imageUrl: 'https://kzrttlhfjhaortkrnqby.supabase.co/storage/v1/object/public/images-site/Caminho%20afetivo.jpg' },
